...
# # REMAINDER A PLACE HOLDER FOR MOVING DATA TABLE DATA
# 
# 
# # Read
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'location_coordinates')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
#   mutate(created_datetime = with_tz(format(created_datetime), tzone = "UTC")) %>%
#   mutate(modified_datetime = with_tz(format(modified_datetime), tzone = "UTC"))
# 
# # Write
# pg_con = pg_con_prod(dbname = "FISH")
...
# 
# #======================================================================================================
# # Copy data tables. EXAMPLE...DO NOT RUN !!!!!!!!!!
# #======================================================================================================
# 
...
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
#   mutate(survey_datetime = with_tz(format(survey_datetime), tzone = "UTC")) %>% 
#   mutate(survey_start_datetime = with_tz(format(survey_start_datetime), tzone = "UTC")) %>% 
#   mutate(survey_end_datetime = with_tz(format(survey_end_datetime), tzone = "UTC")) %>%
#   mutate(created_datetime = with_tz(format(created_datetime), tzone = "UTC")) %>%
#   mutate(modified_datetime = with_tz(format(modified_datetime), tzone = "UTC"))
# 
# # Write
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'survey_comment')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'waterbody_measurement')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
#   mutate(start_water_temperature_datetime = with_tz(format(start_water_temperature_datetime), tzone = "UTC")) %>% 
#   mutate(end_water_temperature_datetime = with_tz(format(end_water_temperature_datetime), tzone = "UTC")) %>%
#   mutate(created_datetime = with_tz(format(created_datetime), tzone = "UTC")) %>%
#   mutate(modified_datetime = with_tz(format(modified_datetime), tzone = "UTC"))
# 
# # Write
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'fish_encounter')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
#   mutate(fish_encounter_datetime = with_tz(format(fish_encounter_datetime), tzone = "UTC")) %>% 
#   mutate(created_datetime = with_tz(format(created_datetime), tzone = "UTC")) %>%
#   mutate(modified_datetime = with_tz(format(modified_datetime), tzone = "UTC"))
# 
# # Write
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'individual_fish')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'redd_encounter')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
#   mutate(redd_encounter_datetime = with_tz(format(redd_encounter_datetime), tzone = "UTC")) %>% 
#   mutate(created_datetime = with_tz(format(created_datetime), tzone = "UTC")) %>%
#   mutate(modified_datetime = with_tz(format(modified_datetime), tzone = "UTC"))
# 
# # Write
...
# # Get values from source
# pg_con = pg_con_local(dbname = "spawning_ground")
# dat = dbReadTable(pg_con, 'individual_redd')
# dbDisconnect(pg_con)
# 
# # Manually convert timezones (aaarg!)
# dat = dat %>% 
